...
import PriceIcon from "assets/svg/download.svg";
        ...
        <Container>
            <ContainerInner>
                <Info>
                    ...
                    <Description>Компания «Султан» — снабжаем розничные магазины товарами
                        "под ключ" в Кокчетаве и Акмолинской области</Description>
                    <Subscribe>
                        <SubscribeTitle>Подпишись на скидки и акции</SubscribeTitle>
                        <SubscribeContainer>
                            <SubscribeInput placeholder="Введите ваш E-mail"/>
                            <SubscribeBtn>
                ...
                <Row>
                    ...
                    <Navigation>
                        ...
                        <NavigationItem href="">Бытовая химия</NavigationItem>
                        <NavigationItem href="">Косметика и гигиена</NavigationItem>
                        <NavigationItem href="">Товары для дома</NavigationItem>
                        <NavigationItem href="">Товары для детей и мам</NavigationItem>
                        <NavigationItem href="">Посуда</NavigationItem>
                    </Navigation>
                    <PriceList>
                        <PriceListTitle>Скачать прайс-лист:</PriceListTitle>
                        <PriceListBtn>
                            <ButtonText>Прайс-лист</ButtonText>
                            <img src={PriceIcon} alt=""/>
                        </PriceListBtn>
                        <MessengerTitle>Связь в мессенджерах:</MessengerTitle>
                        <MessengerRow>
                            <MessengerItem href="">
                    ...
                    <Contact>
                        ...
                        <ContactInfo>
                            <ContactPhone href="tel:+77774900091">+7 (777) 490-00-91</ContactPhone>
                            <ContactTime>время работы: 9:00-20:00</ContactTime>
                            <ContactCallback href="">Заказать звонок</ContactCallback>
                        </ContactInfo>
                        <ContactMail>
...
const Row = styled.div`
  display: grid;
  grid-template-columns: 129px 170px 214px 152px;
  justify-content: space-between;
  width: 100%;
  gap: 25px;
  @media (max-width: 1100px) {
    grid-template-columns: 126px 145px 152px 123px;
  }
  @media (max-width: 700px) {
    grid-template-columns: 152px 145px;
    grid-template-rows: 220px 227px;
...
`
const PriceListTitle = styled(Title)`
  @media (max-width: 700px) {
    display: none;
  }
`
...
`
const MessengerRow = styled.div`
  display: flex;
  gap: 10px;
  align-items: center;
`
const MessengerItem = styled.a`
...
`
const ContactTime = styled.p`
  font-weight: 300;
  font-size: 12px;
  line-height: 150%;
  color: #FFFFFF;
`
const ContactCallback = styled.a`
  font-weight: 400;
  font-size: 10px;
  line-height: 150%;
